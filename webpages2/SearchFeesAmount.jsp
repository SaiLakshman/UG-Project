...
<body>
   <h1 align= "center"><b>This is to Search, if the Fees_Amount Exists for the Year and Semester</b></h1>
   ...
   <table align= "center">
     ...
     <tr>
   	<td class= "labelred" align= "right"> <input type= "button" name= "btnSearch" value= "Search" onclick= "javascript:searchFees()"></td>
     </tr>
   </table>
