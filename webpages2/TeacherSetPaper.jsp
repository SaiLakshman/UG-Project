...
<body>
<center>
<form name= "teachersetpaperForm" method= "post" action="/Project1/campusteacher">
<h1><font color= "green"><u>Allocate Teachers</u></font></h1>
...
<tr>
	...
	%>
					...
					<td class= "sai1b"><select name="1teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
					%>
							<option value="<%= teach.get(i).getTeacherid() %>">
...
<tr>
	...
	for(int cnt= 0;cnt < pap.size(); cnt++)
	{
		...
		{
	%>
					<td class= "sai12"><font color= red><%=pap.get(cnt).getPaper_code()%>--<font color= blue><%=pap.get(cnt).getPaper_title()%></font></td>
					<td class= "sai12"><select name="2teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
...
<tr>
	...
	for(int cnt= 0;cnt < pap.size(); cnt++)
	{
		...
		{
	%>
					<td class= "sai1b"><font color= red><%=pap.get(cnt).getPaper_code()%>--<font color= blue><%=pap.get(cnt).getPaper_title()%></font></td>
					<td class= "sai1b"><select name="3teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
...
<tr>
	...
	%>
					<td class= "sai12"><font color= red><%=pap.get(cnt).getPaper_code()%>--<font color= blue><%=pap.get(cnt).getPaper_title()%></font></td>
					<td class= "sai12"><select name="4teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
...
<tr>
	...
	%>
					<td class= "sai1b"><font color= red><%=pap.get(cnt).getPaper_code()%>--<font color= blue><%=pap.get(cnt).getPaper_title()%></font></td>
					<td class= "sai1b"><select name="5teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
...
<tr>
	...
	%>
					<td class= "sai12"><font color= red><%=pap.get(cnt).getPaper_code()%>--<font color= blue><%=pap.get(cnt).getPaper_title()%></font></td>
					<td class= "sai12"><select name="6teachpaperid" id="teachpapername">
					<option value="">SELECT</option>				
					<%
			 		for(int i= 0;i < teach.size();i++)
					{
...
<input type= "button" name= "coursepaper" value="Submit" onclick= "javascript:setteacherpapers()">
