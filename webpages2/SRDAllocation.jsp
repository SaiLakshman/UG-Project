...
<body>
<h2 align= center>SRDView/Allocation</h2>
<form name= "srdview" method="post" action= "/Project1/hostelteacher">
<table align= "center">
  <tr class= "sai1">
     <td>Year:</td>
  ...
  <tr class= "sai1">
     ...
     <input Name= "Submit" type= "button" value="submit" onclick= "javascript: SrdAllocation()"></td>
  </tr>
</table>
