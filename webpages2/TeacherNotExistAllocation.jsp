...
<body>
<% TeacherAllocation get= (TeacherAllocation) request.getAttribute("notexist"); %>
...
<table align= "center">
	...
	if(get.getSemester() % 2 == 0)
	{
		...
		%>
	<tr><td>No Teacher Room Allocation Found.</td>
	    <td></td>
	    <td align= "right"><input Name= "freshallocation" type= "button" value= "Fresh Allocation" onclick= "javascript: teacherfreshAllocation()"></td></tr>
	<%  int k= 20;
		while(k> 0)
		{
		%>
